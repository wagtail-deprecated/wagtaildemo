...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('demo_advertplacement', 'demo_advertsnippetplacement')
        db.rename_table('demo_advert', 'demo_advertsnippet')

    def backwards(self, orm):
        db.rename_table('demo_advertsnippetplacement', 'demo_advertplacement')
        db.rename_table('demo_advertsnippet', 'demo_advert')
    ...
    models = {
        ...
        u'demo.advertsnippet': {
            'Meta': {'object_name': 'AdvertSnippet'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'demo.advertsnippetplacement': {
            'Meta': {'object_name': 'AdvertSnippetPlacement'},
            'advert': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['demo.AdvertSnippet']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
